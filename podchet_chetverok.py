...
for i in range(222, 1286):  # while (ik < 1): # количество файлов
	...
	while (steps < len(viborka)):
		...
		if old_key3 > -1:
			list_dvoek.append((old_key3,old_key2,old_key1,key1))
...
sorted_chetverki = sorted(dvoyki.items(), key=operator.itemgetter(0))

print('sorted_chetverki: ', sorted_chetverki)
